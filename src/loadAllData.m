...
trainDataIJV = load('./20news-bydate/data/train.data');
testDataIJV = load('./20news-bydate/data/test.data');
...
trainLabels = load('./20news-bydate/data/train.label');
testLabels = load('./20news-bydate/data/test.label');


% this next block of code assumes the training and testing maps are the same
fid = fopen('./20news-bydate/data/train.map', 'r');
